            ...
            <div className='home-logos'>
                <div >
                    <img
                        ...
                        alt='cleaning logo' onClick={() => navigate("/services")}/>
                ...
                <div>
                    <img
                        ...
                        alt='gardening logo' onClick={() => navigate("/services")} />
                    <p className='logo-home-title'>Gardening</p>
                </div>
                <div>
                    <img
                        src={require('../images/painting.jpg')}
                        alt='painting logo' onClick={() => navigate("/services")} />
