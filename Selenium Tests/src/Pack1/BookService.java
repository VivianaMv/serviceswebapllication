...
class BookService {
	...
	void testBookAService() {
		...
		WebElement googleBtn = driver.findElement(By.xpath("//*[@id=\"yDmH0d\"]/div[1]/div[1]/div[2]/div/div/div[2]/div/div/div[1]/form/span/section/div/div/div/div/ul/li[1]/div/div[1]/div"));
		googleBtn.click();
    ...
    WebElement bookServiceBtn1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div[2]/div[3]/table/tbody/tr[2]/td[3]/button")));
	...
	WebElement bookServiceBtn2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div[2]/div[3]/table/tbody/tr[3]/td[3]/button")));
	...
	WebElement googleBtn2 = driver.findElement(By.xpath("//*[@id=\"yDmH0d\"]/div[1]/div[1]/div[2]/div/div/div[2]/div/div/div[1]/form/span/section/div/div/div/div/ul/li[1]/div/div[1]/div"));
	googleBtn2.click();
    ...
    void testStoreNameInBookService() {
        ...
        WebElement storeNameElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div[2]/div[3]/table/tbody/tr[1]/td[1]")));
	...
	void testHeaderHomeButton() {
		...
		WebElement homeBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div[1]/div[2]/a[1]")));
		homeBtn.click();
	...
	void testHeaderServicesButton() {
		...
		WebElement servicesBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div[1]/div[2]/a[2]")));
		servicesBtn.click();
	...
	void testHeaderAboutButton() {
		...
		WebElement aboutBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div[1]/div[2]/a[3]")));
		aboutBtn.click();
	...
	void testHeaderContactButton() {
		...
		WebElement contactBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div[1]/div[2]/a[4]")));
		contactBtn.click();
